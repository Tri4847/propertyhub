...
<div class="property-details">
    ...
    <p>Price: $<?php echo htmlspecialchars($property['price']); ?>
     | Bedrooms: <?php echo htmlspecialchars($property['bedrooms']); ?>
      | Baths: <?php echo htmlspecialchars($property['baths']); ?>
       | Sqrft: <?php echo htmlspecialchars($property['details']); ?></p>
</div>
